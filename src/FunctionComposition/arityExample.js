...
// The goal of arity is to have a function that has the users array bound to it 
// So that we do not have to pass in users as a param

// Similarly we want a function where 30 is bound to the function 
// So that we do not havet to pass 30 to it
...
// Bind users to the function
const partGetUser = getUser.bind(null, users);
// Bind 30 to functions
const partUpdateScore30 = updateScore.bind(null, 30);

export const updateUser = pipe(
    partGetUser,
    cloneObj,
    partUpdateScore30,
    updateTries);

export const newestUser = updateUser("Henry");
